%% ambiente
raio_esferas = 0.025;
e1 = struct('raio',raio_esferas,'centro',[0.05;0.25;0.15]);
e2 = struct('raio',raio_esferas,'centro',[0.08;0.08;0.05]);
e3 = struct('raio',raio_esferas,'centro',[-0.05;0.25;0.15]);
e4 = struct('raio',raio_esferas,'centro',[-0.08;0.08;0.05]);

e5 = struct('raio',raio_esferas,'centro',[0.08;0;0.15]);
e6 = struct('raio',raio_esferas,'centro',[-0.08;0;0.15]);
e7 = struct('raio',raio_esferas,'centro',[0;0.16;0.1]);
e8 = struct('raio',raio_esferas,'centro',[0;0.08;0.15]);
