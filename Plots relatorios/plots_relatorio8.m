...
%% junta1
A = eye(4);
plot_junta_revolucao(A,[0;0;0],'z',h,radius,color);
hold on
text(0-a,0-a,0+2*a,'J_1','FontSize',14,...
...
text(0-a,0-a,5*0.075+2*a,'J_6','FontSize',14,...
  'FontWeight', 'bold','color','red')
%% junta7
A(1:3,end) = [0;0;6*0.075];
A(1:3,1:3) = axang2rotm([0,1,0,pi/2]);
plot_junta_revolucao(A,[0;0;-h/2],'z',h,radius,color);
text(0-a,0-a,6*0.075+2*a,'J_7','FontSize',14,...
  'FontWeight', 'bold','color','red')
%% efetuador
plot_esfera([0;0;7*0.075],1.5*radius,color,1);
%% elos
plot3([0,0],[0,0],[0,7*0.075],'color',color,'LineWidth',3);
