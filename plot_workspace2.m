...
plot3([p0_0(x),p1_0(x),p2_0(x)]...
  ...
  ,[p0_0(z),p1_0(z),p2_0(z)],'-*','markersize',5,'linewidth',3);
...
%È a revolução de um anel, o qual varia entre uma casca de uma toróide
%até um disco com um furo no meio